  ...
  return (
    <Stack gap={24}>
      ...
      <Grid columns={4} gap={16}>
        ...
        <Stat value="580 млн" label="Дом забирает, кристаллы" />
        <Stat value="1.16 млрд" label="Депозит на 6 млн спинов, кристаллы" />
      </Grid>
      ...
      <Stack gap={8}>
        ...
        <BarChart
          categories={["Элементы", "Мечи", "Персонажи", "Щиты", "Экипировка", "Питомцы"]}
          series={[
            {
              name: "Было, % депозита",
      ...
      <Stack gap={8}>
        ...
        <Table
          ...
          striped
          rows={[
            ["Элементы", "160", "80.0", "50.0%", "50.1%", "+79.8 млн"],
            ["Мечи", "200", "100.0", "50.0%", "49.9%", "+100.2 млн"],
            ["Персонажи", "190", "95.0", "50.0%", "49.8%", "+95.4 млн"],
            ["Щиты", "220", "110.0", "50.0%", "50.2%", "+109.6 млн"],
            ["Экипировка", "180", "90.0", "50.0%", "49.9%", "+90.1 млн"],
            ["Питомцы", "210", "105.0", "50.0%", "50.1%", "+104.8 млн"],
            ["Все кейсы", "—", "—", "50.0%", "50.0%", "+579.9 млн"],
          ]}
        />
        <Text size="small" tone="tertiary">
          Кристаллы. Шансы в каждом кейсе суммируются в 100. Продажа идёт по полной
      ...
      <Stack gap={8}>
        ...
        <Table
          ...
          columnAlign={["left", "right", "right", "right", "right", "right"]}
          rows={[
            ["Элементы", "77.97%", "10.14%", "7.48%", "3.75%", "0.66%"],
            ["Мечи", "77.64%", "10.33%", "7.31%", "3.86%", "0.86%"],
            ["Персонажи", "77.01%", "10.17%", "7.92%", "4.02%", "0.88%"],
            ["Щиты", "83.64%", "6.79%", "5.47%", "3.17%", "0.93%"],
            ["Экипировка", "77.12%", "10.55%", "7.49%", "3.96%", "0.88%"],
            ["Питомцы", "83.68%", "6.77%", "5.54%", "3.08%", "0.93%"],
          ]}
        />
        <Text size="small" tone="tertiary">
